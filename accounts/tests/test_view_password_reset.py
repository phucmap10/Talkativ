...
class PasswordResetConfirmTests(TestCase):
    ...
    def test_form_inputs(self):
        ...
        '''
        self.assertContains(self.response, '<input', count=3)
        self.assertContains(self.response, 'type="password"', count=2)
...
class InvalidPasswordResetConfirmTests(TestCase):
    def setUp(self):
        ...
        # Construct the URL for password reset confirmation
